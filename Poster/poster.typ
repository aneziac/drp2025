...
#let chambers_and_nerves = [
  #pad(bottom: 0.2cm)[
    For the following definitions let $(W, S)$ be a Coxeter system. Then, for the diagrams shown below, let $
      W^((0))
...
#let Davis_complex_CAT0 = [
  ...
  // $
  be a chamber in $RR^n$ generated by the intersection of the half spaces produced by the hyperplanes $H_t$ for $t in T$ as in the *Tits Representation* defined in the following section.
